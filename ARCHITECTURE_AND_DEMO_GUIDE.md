...
| :--- | :--- |
| `prowler_get_findings` | Query live findings by severity, provider (`azure`, `oraclecloud`, `aws`), or check ID |
| `prowler_get_resources` | Multi-cloud inventory inspection |
...
* **Winning Answer**: 
  > *"Our AI does not guess. It uses Grounded Retrieval (RAG) tied strictly to deterministic Prowler audit rules, CIS benchmark specifications, and official cloud provider SDK definitions. Furthermore, every generated Terraform or CLI script undergoes static schema validation before presenting to the human engineer."*
...
* **Winning Answer**: 
  > *"We support 20+ global frameworks across cloud, industry, government, and privacy, including CIS Benchmarks (Azure v2.0/v3.0, OCI v2.0, AWS v3.0), SOC 2 Type II, ISO/IEC 27001:2022, NIST CSF v2.0, NIST 800-53, PCI-DSS v4.0, HIPAA, GDPR, DORA, NIS2, and FedRAMP."*
