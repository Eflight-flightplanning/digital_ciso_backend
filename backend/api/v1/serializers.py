...
# =============================================================================
# HITL & MANAGED SERVICE SERIALIZERS
# =============================================================================

from api.models import ManagedServiceConfig, HITLReviewQueue, ReviewDecision, DecisionLog


class ManagedServiceConfigSerializer(serializers.ModelSerializer):
    class Meta:
        model = ManagedServiceConfig
        fields = [
            "id",
            "tenant",
            "operator_name",
...
class DecisionLogSerializer(serializers.ModelSerializer):
    ...
    class JSONAPIMeta:
        resource_name = "decision-logs"



class TenantLLMConfigSerializer(serializers.ModelSerializer):
    class Meta:
...
class FindingAIAnalysisSerializer(serializers.ModelSerializer):
    class Meta:
        model = FindingAIAnalysis
        fields = [
            "id",
            "finding_id",
            "finding_hash",
    ...
    class JSONAPIMeta:
        resource_name = "finding-ai-analyses"
...
class CISOAdvisorConversationSerializer(serializers.ModelSerializer):
    class Meta:
        model = CISOAdvisorConversation
        fields = [
            "id",
            "question",
            "answer",
