  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-xs font-semibold cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-98",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-surface-2/50 text-foreground shadow-sm hover:border-primary/40 hover:text-primary",
        secondary: "bg-surface-2 text-foreground shadow-sm hover:bg-surface-2/80",
        ghost: "hover:bg-surface-2 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
      },
      size: {
        default: "h-10 min-w-[130px] px-5 py-2.5",
        sm: "h-8 min-w-[90px] rounded-lg px-3.5 text-xs font-medium",
        lg: "h-11 min-w-[160px] rounded-lg px-8 text-sm",
